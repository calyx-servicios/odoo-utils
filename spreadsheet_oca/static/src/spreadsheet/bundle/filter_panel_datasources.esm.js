...
} from "@spreadsheet_oca/vendor/ui/domain_selector";
...
import {RowsColsDialog} from "@spreadsheet_oca/vendor/ui/rows_cols_dialog";
...
export class PivotPanelDisplay extends Component {
    setup() {
        // Dialogs are rendered by the spreadsheet application itself, see
        // ``useDialogService`` in the spreadsheet renderer.
        this.dialog = this.env.spreadsheetDialogs;
            ...
            (await new Promise((resolve) => {
                ...
                this.dialog.add(
                    RowsColsDialog,
                    {
                        ...
                        canHaveDynamicCols: Boolean(cols[0][0].fields.length),
                        onConfirm: (values) => {
                            selection = values;
                        },
                    },
