...
import { OdooViewsDataSource } from "@spreadsheet_oca/vendor/spreadsheet/data_sources/odoo_views_data_source";
import { orderByToString } from "@spreadsheet_oca/vendor/spreadsheet/helpers/helpers";
import { LoadingDataError } from "@spreadsheet_oca/vendor/spreadsheet/o_spreadsheet/errors";
...
export default class ListDataSource extends OdooViewsDataSource {
    ...
    async _load() {
        ...
        this.data = await this._orm.searchRead(
            ...
            // The orm service of Odoo 15 takes the context as a separate
            // argument, it is not part of the options
            context
        );
