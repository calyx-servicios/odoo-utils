...
export default class ListCorePlugin extends CorePlugin {
    ...
    /**
     * @param {string} id
     * @returns {import("@spreadsheet_oca/vendor/spreadsheet/list/list_data_source").default|undefined}
     */
    ...
    /**
     * @param {string} id
     * @returns {Promise<import("@spreadsheet_oca/vendor/spreadsheet/list/list_data_source").default>}
     */
