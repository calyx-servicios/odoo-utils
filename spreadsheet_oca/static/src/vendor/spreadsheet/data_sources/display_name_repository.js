...
import { Deferred } from "@spreadsheet_oca/vendor/web/utils";
import { LoadingDataError } from "../o_spreadsheet/errors";
// The Odoo 15 transpiler does not support a default and named imports on
// the same line
import BatchEndpoint from "./server_data";
import { Request } from "./server_data";
