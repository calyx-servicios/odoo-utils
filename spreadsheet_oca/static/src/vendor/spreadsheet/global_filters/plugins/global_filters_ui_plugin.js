...
/**
 * @typedef {import("@spreadsheet_oca/vendor/spreadsheet/data_sources/metadata_repository").Field} Field
...
import CommandResult from "@spreadsheet_oca/vendor/spreadsheet/o_spreadsheet/cancelled_reason";

import { isEmpty } from "@spreadsheet_oca/vendor/spreadsheet/helpers/helpers";
import { FILTER_DATE_OPTION } from "@spreadsheet_oca/vendor/spreadsheet/assets_backend/constants";
import {
    checkFiltersTypeValueCombination,
    getRelativeDateDomain,
} from "@spreadsheet_oca/vendor/spreadsheet/global_filters/helpers";
import { RELATIVE_DATE_RANGE_TYPES } from "@spreadsheet_oca/vendor/spreadsheet/helpers/constants";
