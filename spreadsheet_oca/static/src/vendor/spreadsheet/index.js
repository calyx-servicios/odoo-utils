...
import { GlobalFiltersCorePlugin, GlobalFiltersUIPlugin } from "@spreadsheet_oca/vendor/spreadsheet/global_filters/index";
import { PivotCorePlugin, PivotUIPlugin } from "@spreadsheet_oca/vendor/spreadsheet/pivot/index"; // list depends on filter for its getters
import { ListCorePlugin, ListUIPlugin } from "@spreadsheet_oca/vendor/spreadsheet/list/index"; // pivot depends on filter for its getters
import {
    ChartOdooMenuPlugin,
    OdooChartCorePlugin,
    OdooChartUIPlugin,
} from "@spreadsheet_oca/vendor/spreadsheet/chart/index"; // Odoochart depends on filter for its getters
