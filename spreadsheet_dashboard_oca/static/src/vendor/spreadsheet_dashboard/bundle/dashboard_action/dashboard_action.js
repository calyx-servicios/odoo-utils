...
import { FilterValue } from "@spreadsheet_oca/vendor/spreadsheet/global_filters/components/filter_value/filter_value";
...
const { Component, onWillStart, useState, useEffect } = window.owl2;
...
export class SpreadsheetDashboardAction extends Component {
    setup() {
        ...
        // ``useSetupAction`` belongs to the owl 1 runtime of the web client:
        // the dashboard state is not restored through the breadcrumb here.
...
// The client action itself is registered by the owl 1 bridge, see
// @spreadsheet_dashboard_oca/dashboard/dashboard_client_action
