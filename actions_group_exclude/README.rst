======================
actions_group_exclude
======================

.. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! This module adds an option to hide actions to !!
...
This module adds an option to hide actions to specific user groups.

Install
=======

* Go to applications > Find module "actions_group_exclude" > Press Install

Note
=======
* This module is compatible with Odoo 17 and should work in any environment.
